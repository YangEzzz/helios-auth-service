...
func GetDetailName(action, details string) string {
	...
	translated = strings.ReplaceAll(translated, "Locked user", "已锁定用户")
	translated = strings.ReplaceAll(translated, "Unlocked user", "已解锁用户")
